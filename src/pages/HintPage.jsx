    ...
    return (
        <div className="container">
            ...
            <div className="content">
                ...
                <p style={{ color: '#1ea6bc', fontSize: '23px', textAlign: 'left', marginLeft: '17%', marginTop: '15px' }}>Ask ChatGPT</p>
                ...
                <br />
                <br />
                <button style={{ width: 120, height: 40, Opacity: 0.1, marginTop: '-10px' }} onClick={() => navigate(-1)}>Back</button>
            </div>
            </div>
    );
}
